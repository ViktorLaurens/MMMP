...
def main():
    ...
    panda1 = Panda(base_position=(0.5, 0, 0.01), base_orientation=(0, 0, 1, 0))  # Specify base position and orientation for robot1
    panda2 = Panda(base_position=(-0.5, 0, 0.01), base_orientation=(0, 0, 0, 1))  # Specify base position and orientation for robot2
    ...
    tool_position_start1 = (-0., -0.2, 0.5)
    ...
    arm1_start = panda1.solve_closest_arm_ik(tool_pose_start1, reference_joint_positions)
    ...
    arm1_goal = panda1.solve_closest_arm_ik(tool_pose_goal1, arm1_start)
    ...
    tool_position_start2 = (0., 0.2, 0.5)
    ...
    arm2_start = panda2.solve_closest_arm_ik(tool_pose_start2, reference_joint_positions)
    ...
    arm2_goal = panda2.solve_closest_arm_ik(tool_pose_goal2, arm2_start)
    ...
    prm = PrioritizedPRM(env, maxdist=0.1, k1=10, k2=3, build_type='n', prm_type='distance', n=20, t=10, time_step=0.01, local_step=0.02)
